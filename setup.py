...
def get_version():
    """
    Get version number from the wytham-logparser module.
    The easiest way would be to just ``import wythamlogparser``, but note that this may  # noqa
    ...
    sys.path.append(os.path.abspath('wythamlogparser'))
...
setup(
    ...
    name='wytham-logparser',

    # Version
    version=get_version(),

    description='Package for processing logger data files for the Wytham Woods rodent project.',  # noqa
